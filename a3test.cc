...
void q2() {
    ...
    Attribute IA = {"p_partkey", Int};
    Attribute SA = {"p_name", String};
    Attribute DA = {"p_retailprice", Double};
...
void q6() {
    ...
    G.Use_n_Pages(1);
    Attribute myDistinctAtt[] = {s_nationkey};
    Schema dist_sch("dist_sch", 1, myDistinctAtt);
    OrderMaker dist_order(&dist_sch);
