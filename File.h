...
public:
	...
	//Return 1 if it's empty otherwise return 0
	int IsEmpty();
...
public:
	...
	//Added this function as GetLength() does not return proper values
	//When the file is empty or it contains some page
	off_t GetActualLength ();
